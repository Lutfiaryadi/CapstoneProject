...
while True:
    ...
    if role == "1":
            ...
            if pilih_penjual == "1":
                ...
                for p in product_list:
                    if p[0] == kode:
                        ...
                        break
                if sudah_ada:
                    print("Produk sudah ada. Gunakan menu Update untuk menambah stok.")
                else:
        ...
        while True:
            ...
            if pilih_pembeli == "1":
                ...
                if cart:
                    ...
                    konfirmasi = input("Bayar sekarang? (Y/N): ").strip().upper()
                    if konfirmasi == "Y":
        ...
        print("\nTerima kasih sudah mampir ke Kidoo's Store. Sampai jumpa!\n")
        break
